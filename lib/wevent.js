...
class Wevent {
  ...
  on(object, eventListener) {
    ...
    this.emit(this.on, object, eventListener);
  ...
  off(object, eventListener) {
    ...
    let result = false;
    if (!eventListeners) return result;
    ...
    this.emit(this.off, object, eventListener);
    return result;
  }
  ...
  emit(object) {
    ...
    if (object !== this.emit) this.emit(this.emit, ...emitArguments);
